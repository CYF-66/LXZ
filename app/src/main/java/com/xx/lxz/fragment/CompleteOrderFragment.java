...
import static com.xx.lxz.api.MessageCode.GETCOMPLETEORDERLIST;

/**
 * Created by chenyf45 on 2018/5/29.
 */

public class CompleteOrderFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener {
                ...
                case GETCOMPLETEORDERLIST:
                    ...
                    if(order.getCode()==1){
                        if(order.getData().getList()!=null&&order.getData().getList().size()>0){
                            ...
                            OrderAdapter adapter = new OrderAdapter(mContext, dataList,"0");
                            refreshRecyclerView.setAdapter(adapter);
