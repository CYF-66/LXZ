...
import static com.xx.lxz.api.MessageCode.TOTAOBAO;

public class TBAuthenActivity extends BaseActivity implements OnLoginResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity=TBAuthenActivity.this;
        tv_title.setText("授权认证");
        customProgressDialog=new CustomProgressDialog(mActivity);
//        List<String> steps = Arrays.asList(new String[]{"身份认证", "信息认证", "联系人信息", "常用联系人","运营商认证","淘宝认证"});
...
//        serviceId服务类型可以参考ServiceId类，eg:ServiceId.TB_SERVICE_ID为淘宝授权成功
        ...
        int id=ServiceId.TB_SERVICE_ID;
...
//                        jsonobject.put("type", 1);
                        ...
                        String result= HttpService.httpClientPost(mActivity, HttpConstant.GETTBAOBAOAUTH,jsonobject);
