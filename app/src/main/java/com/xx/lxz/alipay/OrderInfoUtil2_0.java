...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String proName, String total_amount, String desp) {
		...
		keyValues.put("app_id", "2018052360203156");// 合作身份者id

		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""+total_amount+"\",\"subject\":\""+proName+"\",\"body\":\""+desp+"\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}");
