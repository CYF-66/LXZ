...
public class BaiDuPushReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        String responseString = "onBind errorCode=" + errorCode + " appid="
                ...
                + " requestId=" + requestId;
        Log.d("TEST", "onBind========="+responseString);

        if (errorCode == 0) {

            // 绑定成功
            Log.d(TAG, "绑定成功");
            PublicParams.channelId=channelId;
        }else{
            PublicParams.channelId="";
        }
    }
    ...
    public void onMessage(Context context, String message,
        ...
        Log.d("TEST", "透传消息 onMessage="+messageString);
...
//        Log.d(TAG, notifyString);
        ...
        Log.d("TEST", "通知到达 onNotificationArrived="+notifyString);
...
//        Log.d(TAG, notifyString);
        Log.d("TEST", "通知到达 onNotificationClicked="+notifyString);
    ...
    private void updateContent(Context context, String content) {
        ...
        String logText = "" + ToolUtils.logStringCache;
        ...
        ToolUtils.logStringCache = logText;
