...
public class RefreshHeaderView extends FrameLayout implements SwipeRefreshTrigger,SwipeTrigger   {
    ...
    public void onPrepare() {
        //下拉之前调用此方法
        tvTip.setText(getResources().getString(R.string.drop_down_refresh));
    ...
    public void onMove(int yScrolled, boolean isComplete, boolean automatic) {
        if (!isComplete) {
            ...
            if (yScrolled >= getHeight()) {
                ...
                tvTip.setText(getResources().getString(R.string.release_immediately_refresh));
    ...
    public void onComplete() {
        //加载完成之后调用此方法
        tvTip.setText(getResources().getString(R.string.refresh_end));
    ...
    public void onReset() {
        //重置
        tvTip.setText(getResources().getString(R.string.drop_down_refresh));
        iconRefresh.setImageResource(R.mipmap.xlistview_arrowicon);
        Log.i("info","onReset");
    }
}
